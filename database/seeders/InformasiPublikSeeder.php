...
class InformasiPublikSeeder extends Seeder
{
    ...
    public function run()
    {
        $akademiks = [
            [
                'keyword'               => 'Pakta Integritas Fakultas Bahasa Asing UNIBA Madura',
                'image_header'          => 'default.JPG',
                'category_informasi_publik_id'   => '1',
            ],
            [
                'keyword'               => 'Aturan Gratifikasi Fakultas Bahasa Asing UNIBA Madura',
                'image_header'          => 'default.JPG',
            ...
            [
                'keyword'               => 'Uniba Madura Expo Fakultas Bahasa Asing UNIBA Madura',
                'image_header'          => 'default.JPG',
                'category_informasi_publik_id'   => '4',
            ],
            [
                'keyword'               => 'SOP Fakultas Bahasa Asing UNIBA Madura',
                'image_header'          => 'default.JPG',
