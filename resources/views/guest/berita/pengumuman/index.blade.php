@extends('layouts.app')
@section('active-berita', 'current')

@section('content')
    <!--Start breadcrumb area paroller-->
    <section class="breadcrumb-area">
        <div class="breadcrumb-area-bg" style="background-image: url({{ asset('images/berita-pengumuman/'. $berita->image_header) }});">
        </div>
        <div class="container">
            <div class="row">
                <div class="col-xl-12">
            ...
            <div class="row">
                ...
                <div class="col-xl-9 ">
                    <div class="blog-page-two__content">
                        <div class="row">
                            <div class="col-xl-12">
                                @if($berita && $contentBerita && $pengumuman)
                                <!--Start Single Blog Style2-->
                                @foreach($pengumuman as $row)
                                <?php
                                    $lessContent = substr($row->content, 0, 100);
                                    $countString = strlen($lessContent);
                                ?>
                                <div class="single-blog-style2">
                                    <div class="single-blog-style2__img-holder">
                                        <div class="inner">
                                            <img loading="lazy" width="300" height="275"
                                                src="{{ asset('images/berita-pengumuman/'. $row->image_content) }}"
                                                class="attachment-educamb_300x275 size-educamb_300x275 wp-post-image"
                                                alt=""
                                                srcset="https://fastwpdemo.com/newwp/educamb/wp-content/uploads/2022/06/blog-details-img-1-300x275.jpg 300w, https://fastwpdemo.com/newwp/educamb/wp-content/uploads/2022/06/blog-details-img-1-370x340.jpg 370w"
                                    ...
                                    <div class="single-blog-style2__text-holder">
                                        <div class="top">
                                            <div class="category-box">
                                                ...
                                                <p><a href="{{ route('guest.pengumuman-fba') }}" rel="category tag">Pengumuman</a></p>
                                            </div>
                                        </div>
                                        <h3 class="blog-title">
                                            <a href="{{ route('berita-pengumuman-fba.show',$row->id) }}">{{ $row->title }}</a>
                                        </h3>
                                        @if($countString == 100)
                                            <div class="text">{{ $lessContent }}&hellip;</div>
                                        @else
                                            <div class="text">{{ $lessContent }}</div>
                                        @endif
                                        <div class="bottom-box">
                                            <div class="btn-box">
                                                <a
                                                    href="{{ route('berita-pengumuman-fba.show',$row->id) }}">
                ...
                <div class="col-xl-3 col-lg-5">
                    <div class="thm-sidebar-box">
                        ...
                        <div id="categories-2" class="widget sidebar-search-box widget_categories">
                            ...
                            <ul>
                                <li class="cat-item cat-item-35"><a href="{{ route('guest.informasi-fba') }}">Informasi</a>
                                </li>
                                <li class="cat-item cat-item-86"><a href="{{ route('guest.pengumuman-fba') }}">Pengumuman</a>
                                </li>
                                <li class="cat-item cat-item-28"><a href="{{ route('guest.agenda-fba') }}">Agenda</a>
                                </li>
                            </ul>
                                            ...
                                            <div class="inner">
                                                <div class="img-box"
                                                    ...
                                                    <div class="overlay-content">
                                                        <a href=" @if($row->berita->category_berita_id == 1) {{route('berita-informasi-fba.show',$row->id)}} @elseif($row->berita->category_berita_id == 2) {{route('berita-pengumuman-fba.show',$row->id)}} @else # @endif"><i class="fa fa-link" aria-hidden="true"></i>
                                                    </a>
                                                    </div>
                                                </div>
                                                <div class="title-box">
                                                    ...
                                                    <h4>
                                                        <a href=" @if($row->berita->category_berita_id == 1) {{route('berita-informasi-fba.show',$row->id)}} @elseif($row->berita->category_berita_id == 2) {{route('berita-pengumuman-fba.show',$row->id)}} @else # @endif">{{ substr($row->title,0,30) }}&hellip;</a>
                                                    </h4>
                                                </div>
                                            </div>
                                        </li>
