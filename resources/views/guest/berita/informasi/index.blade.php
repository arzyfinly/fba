...
@section('content')
    ...
    <section class="breadcrumb-area">
        <div class="breadcrumb-area-bg" style="background-image: url({{ asset('images/berita-informasi/'. $berita->image_header) }});">
        </div>
        <div class="container">
            <div class="row">
                <div class="col-xl-12">
                                    ...
                                    <div class="single-blog-style2__text-holder">
                                        <div class="top">
                                            <div class="category-box">
                                                ...
                                                <p><a rel="category tag">Informasi</a></p>
                                            </div>
                                        </div>
                                        <h3 class="blog-title">
                                            <a>{{ $row->title }}</a>
                                        ...
                                        <div class="bottom-box">
                                            <div class="btn-box">
                                                <a
                                                    href="{{ route('berita-informasi-fba.show',$row->id) }}">
