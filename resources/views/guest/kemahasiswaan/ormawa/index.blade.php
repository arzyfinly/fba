...
@section('content')
    ...
    <section class="breadcrumb-area">
        <div class="breadcrumb-area-bg" style="background-image: url({{ asset('images/ormawa-fakultas/'. $contentKemahasiswaan->kemahasiswaan->image_header) }});">
        </div>
        <div class="container">
            <div class="row">
                <div class="col-xl-12">
                    <div class="inner-content">
                        ...
                        <div class="breadcrumb-menu">
                            <ul>
                                ...
                                <li class="breadcrumb-item">Tentang Alumni</li>
                            </ul>
                        </div>
                    </div>
                </div>
