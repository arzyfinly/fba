...
@section('content')
    ...
    <section class="breadcrumb-area">
        <div class="breadcrumb-area-bg" style="background-image: url({{ asset('images/prestasimhs-fakultas/'. $contentKemahasiswaan->kemahasiswaan->image_header) }});">
        </div>
        <div class="container">
            <div class="row">
                <div class="col-xl-12">
                    <div class="inner-content">
                        <div class="title">
                            <h2> Prestasi Kemahasiswaan</h2>
                        </div>
                        <div class="breadcrumb-menu">
                            <ul>
                                <li class="breadcrumb-item"><a href="{{ route('home') }}">Home &nbsp;</a></li>
                                <li class="breadcrumb-item">Prestasi Kemahasiswaan</li>
                            </ul>
                        </div>
                    </div>
                </div>
                                ...
                                <div class="text-justify">
                                    <div class="blog-details-page__img-box">
                                        <img width="870" height="470"
                                            src="{{ asset('images/prestasimhs-fakultas/'.$contentKemahasiswaan->image_content) }}"
                                    ...
                                    <div class="text">
                                        <div class="blog-details-page__quote-box">
                                            <div class="text-center">
                                                <h2>{{ $contentKemahasiswaan->title }}</h2>
                                            </div>
                                        </div>
                                    </div>
                                    <br>
                                    <div class="blog-details-page__text-1">{!! $contentKemahasiswaan->content !!}</div>
                                </div>
                            </div>
                        </div>
                    </div>
