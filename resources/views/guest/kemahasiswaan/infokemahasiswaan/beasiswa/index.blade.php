...
@section('content')
    ...
    <section class="breadcrumb-area">
        <div class="breadcrumb-area-bg"
            style="background-image: url({{ asset('images/beasiswa-fakultas/' . $kemahasiswaan->image_header) }});">
        </div>
        <div class="container">
            <div class="row">
                <div class="col-xl-12">
                                ...
                                @foreach ($beasiswa as $row)
                                    <div class="single-blog-style2" id="list">
                                        <div class="single-blog-style2__img-holder">
                                            <div class="inner">
                                                <img loading="lazy"
                                                    src="{{ asset('images/beasiswa-fakultas/' . $row->image_content) }}"
                                                    class="img-fluid" alt="" />
                                            </div>
                                        </div>
                                        <div class="single-blog-style2__text-holder">
                                            <div class="top">
                                                <div class="category-box">
                                                    ...
                                                    <p><a rel="category tag">Beasiswa</a></p>
                                                </div>
                                            </div>
                                            <h3 class="blog-title">
                                                <a href="{{ route('info-kemahasiswaan-beasiswa.show', $row->id) }}">{{ $row->title }}</a>
                                            </h3>
                                            @if(strlen($row->content) >= 150)
                                            <div class="text">{{  strip_tags(substr("$row->content", 0, 120))  }}&hellip;</div>
                                            @else
                                            <div class="text">{!! $row->content !!}</div>
                                            @endif
                                            <div class="bottom-box">
                                                <div class="btn-box">
                                                    <a href="{{ route('info-kemahasiswaan-beasiswa.show', $row->id) }}">
