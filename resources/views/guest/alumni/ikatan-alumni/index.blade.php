...
@section('content')
    ...
    <section class="breadcrumb-area">
        <div class="breadcrumb-area-bg"
            style="background-image: url({{ asset('images/ikatan-alumni/' . $alumni->image_header) }});">
        </div>
        <div class="container">
            <div class="row">
                <div class="col-xl-12">
                    <div class="inner-content">
                        ...
                        <div class="breadcrumb-menu">
                            <ul>
                                ...
                                <li class="breadcrumb-item">Ikatan Alumni</li>
                            </ul>
                        </div>
                    </div>
                </div>
                                        ...
                                        <div class="text">
                                            <div class="blog-details-page__quote-box">
                                                ...
                                                <div class="text-center">
                                                    <h2>{{ $contentAlumni->title }}</h2>
                                                </div>
                                            </div>
                                        </div>
                                        <br>
                                        <div class="blog-details-page__text-1">{!! $contentAlumni->content !!}</div>
                                    </div>
                                </div>
                            </div>
                        @else
                ...
                <div class="col-xl-3 col-lg-5">
                    <div class="thm-sidebar-box">
                        ...
                        <div id="categories-2" class="widget sidebar-search-box widget_categories">
                            ...
                            <ul>
                                ...
                                <li class="cat-item cat-item-86"><a
                                        href="{{ route('guest.pengumuman-fba') }}">Pengumuman</a>
                                </li>
                        ...
                        <div id="educamb_recent_posts-2" class="widget sidebar-search-box widget_educamb_recent_posts">
                            ...
                            $berita = App\Models\ContentBerita::where('publish', '1')
                                ->where('berita_id', $informasi->id)
                                ->orwhere('berita_id', $pengumuman->id)
                                ->limit(3)
                                ->get(); ?>
                                ...
                                <div class="sidebar-blog-post">
                                    <ul class="blog-post">
                                        ...
                                        <li>
                                            <div class="inner">
                                                <div class="img-box"
                                                    style="background-image:url(@if ($row->berita->category_berita_id == 1) {{ asset('images/berita-informasi/' . $row->image_content) }}
                                                                                @elseif($row->berita->category_berita_id == 2)
                                                                                    {{ asset('images/berita-pengumuman/' . $row->image_content) }}
                                                                                @else
                                                                                    {{ asset('images/berita-agenda/' . $row->image_content) }} @endif);">
                                                    <div class="overlay-content">
                                                        <a
                                                            href=" @if ($row->berita->category_berita_id == 1) {{ route('berita-informasi-fba.show', $row->id) }} @elseif($row->berita->category_berita_id == 2) {{ route('berita-pengumuman-fba.show', $row->id) }} @else # @endif"><i
                                                ...
                                                <div class="title-box">
                                                    ...
                                                    <h4>
                                                        <a
                                                            href=" @if ($row->berita->category_berita_id == 1) {{ route('berita-informasi-fba.show', $row->id) }} @elseif($row->berita->category_berita_id == 2) {{ route('berita-pengumuman-fba.show', $row->id) }} @else # @endif">{{ substr($row->title, 0, 30) }}&hellip;</a>
                                                    </h4>
                                                </div>
                                            </div>
                                        </li>
