...
@section('content')
    ...
    <section class="breadcrumb-area">
        <div class="breadcrumb-area-bg" style="background-image: url({{ asset('images/peluang-kerja/'. $contentAlumni->alumni->image_header) }});">
        </div>
        <div class="container">
            <div class="row">
                <div class="col-xl-12">
                                ...
                                <div class="text-justify">
                                    <div class="blog-details-page__img-box">
                                        <img width="870" height="470"
                                            src="{{ asset('images/peluang-kerja/'.$contentAlumni->image_content) }}"
