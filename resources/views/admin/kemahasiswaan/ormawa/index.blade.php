...
@section('ormawa-active', 'active')
@section('kemahasiswaan-active', 'active')

@section('content')
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">{{ __('Ormawa') }}</h1>
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="./">{{ __('Home') }}</a></li>
            <li class="breadcrumb-item">{{ __('Kemahasiswaan') }}</li>
            <li class="breadcrumb-item active" aria-current="page">{{ __('Ormawa FBA') }}</li>
        </ol>
    </div>
    <div class="row">
        <div class="col-lg-12">
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <form action="{{ route('ormawa-fba.header') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                    <table class="ml-2" style="width: 100%">
                        <tr>
                            ...
                            <td>: &nbsp; &nbsp;</td>
                            <td>
                                <input class="form-control @error('keyword') is-invalid @enderror" type="text"  name="keyword" id="keyword" @isset($kemahasiswaan->keyword)
                        ...
                        <tr>
                            ...
                            <td class="pt-4">
                                <label for="file1">
                                    <img id="output1" style="width: 100px " class="img-thumbnail" @isset($kemahasiswaan->image_header) src="{{ asset('images/ormawa-fakultas/'.$kemahasiswaan->image_header) }}" @endisset @empty($kemahasiswaan->image_header) src="{{ asset('images/default/upload-image.png') }}" @endempty>
                                </label> <br>
    ...
    @include('admin.kemahasiswaan.ormawa.create')
    @include('admin.kemahasiswaan.ormawa.scriptdelete')
@endsection
