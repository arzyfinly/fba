...
@section('content')
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">{{ __('Beasiswa FBA') }}</h1>
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="./">{{ __('Home') }}</a></li>
            <li class="breadcrumb-item">{{ __('Profil') }}</li>
            <li class="breadcrumb-item">{{ __('Beasiswa FBA') }}</li>
        ...
        <div class="col-lg-12">
            <div class="card mb-4">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                    <h6 class="m-0 font-weight-bold text-primary">{{ __('Edit Beasiswa FBA') }}</h6>
                ...
                <div class="table-responsive p-3">
                    <form action="{{ route('beasiswa-fba.update', $beasiswa->id) }}" method="POST"
                                    ...
                                    <div class="d-flex flex-column align-items-center text-center p-3 py-5">
                                        ...
                                        <div class="col-sm">
                                            ...
                                            <div class="input-group my-3 text-center">
                                                <img id="output2" class="img-thumbnail" @isset($beasiswa->image_content) src="{{ asset('images/beasiswa-fakultas/'.$beasiswa->image_content) }}" @endisset @empty($beasiswa->image_content) src="{{ asset('images/default/upload-image.png') }}" @endempty>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                ...
                                                <input type="text" name="title"
                                                    ...
                                                    placeholder="ex: Jenis beasiswa" value="{{ $beasiswa->title }}">
                                                @error('title')
                                                    <small class="text-danger">{{ $message }}</small>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="row mt-3">
                                            <div class="col-md-12">
                                                ...
                                                <input type="text" name="description"
                                                    ...
                                                    placeholder="diskripsi" value="{{ $beasiswa->description }}">
                                                @error('description')
                                                    <small class="text-danger">{{ $message }}</small>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="row mt-3 mb-6">
                                            <div class="col-md-12 mt-2">
                                                ...
                                                <input type="hidden" name="content" id="content"
                                                    value="{{ $beasiswa->content }}">
                                                <div id="editor">{!! $beasiswa->content !!}</div>
                                                <script>
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <div class="form-check">
                                                    <input class="form-check-input" name="publish"
                                                        @if ($beasiswa->publish == '1') checked @endif type="checkbox"
                                                        value="1" id="checkbox-1" />
                                                    <input hidden name="category_kemahasiswaan_id" type="text"
                                                        value="1" />
