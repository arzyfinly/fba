                ...
                <div class="col-lg-12">
                    <div class="card mb-4">
                        <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                            <h6 class="m-0 font-weight-bold text-primary">{{ __('Create Beasiswa FBA') }}</h6>
                        ...
                        <div class="table-responsive p-3">
                            <form action="{{ route('beasiswa-fba.store') }}" method="POST"
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        ...
                                                        <input type="text" name="title"
                                                            ...
                                                            placeholder="ex: Jenis beasiswa" value="{{ old('title') }}">
                                                        @error('title')
                                                            <small class="text-danger">{{ $message }}</small>
                                                        @enderror
                                                    </div>
                                                ...
                                                <div class="row mt-3">
                                                    <div class="col-md-12">
                                                        ...
                                                        <input type="text" name="description"
                                                            ...
                                                            placeholder="diskripsi" value="{{ old('description') }}">
                                                        @error('description')
                                                            <small class="text-danger">{{ $message }}</small>
                                                        @enderror
                                                    </div>
                                                    ...
                                                    <div class="col-md-12">
                                                        ...
                                                        <div class="form-check">
                                                            ...
                                                            <label class="form-check-label" for="checkbox-1">Checklist
                                                                kotak
                                                                disamping untuk mempublish konten ini untuk publish!! <br>
                                                            </label>
                                                        </div>
                                                    </div>
                                                </div>
