@extends('layout.app')
@section('title', 'Uniba Madura Expo')
@section('uniba-madura-expo-active', 'active')
@section('download-document-active', 'active')
...
@section('content')
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">{{ __('Uniba Madura Expo') }}</h1>
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="./">{{ __('Home') }}</a></li>
            <li class="breadcrumb-item">{{ __('Download Document') }}</li>
            <li class="breadcrumb-item">{{ __('Uniba Madura Expo') }}</li>
        ...
        <div class="col-lg-12">
            <div class="card mb-4">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                    <h6 class="m-0 font-weight-bold text-primary">{{ __('Edit Uniba Madura Expo') }}</h6>
                ...
                <div class="table-responsive p-3">
                    <form action="{{ route('uniba-madura-expo-fba.update', $download_document->id) }}" method="POST" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                                    ...
                                    <div class="d-flex flex-column align-items-center text-center p-3 py-5">
                                        ...
                                        <div class="col-sm">
                                            ...
                                            <div class="input-group my-3 text-center">
                                                <img id="output2" class="img-thumbnail" @isset($download_document->image_content) src="{{ asset('images/uniba-madura-expo/'.$download_document->image_content) }}" @endisset @empty($download_document->image_content) src="{{ asset('images/default/upload-image.png') }}" @endempty>
                                            </div>
                                        </div>
                                        @error('image_content')
                                ...
                                <div class="col border-right">
                                    <div class="p-3 py-5">
                                        <div class="d-flex justify-content-between align-items-center mb-3">
                                            <h4 class="text-right">Uniba Madura Expo</h4>
                                        </div>
                                        <div class="row mt-2">
                                            <div class="col-md-12">
                                                <label class="labels">Judul</label>
                                                <input value="{{ $download_document->title }}" type="text" name="title"
                                        ...
                                        <div class="row mt-3">
                                            <div class="col-md-12">
                                                ...
                                                <input value="{{ $download_document->description }}" type="text" name="description"
                                            ...
                                            <div class="col-md-12 mt-2">
                                                ...
                                                <textarea class="form-control @error('content') is-invalid @enderror" name="content" id="exampleFormControlTextarea1"
                                                    rows="4" style="font-size: 10pt"> {{ $download_document->content }} </textarea>
                                            ...
                                            <div class="col-md-12 mt-2">
                                                ...
                                                <input value="{{ $download_document->date }}" type="date" name="date"
                                        ...
                                        <div class="row mt-3">
                                            <div class="col-md-12">
                                                ...
                                                <div class="form-check">
                                                    <input @if($download_document->publish == 1) checked @endif class="form-check-input" name="publish" type="checkbox" value="1" id="checkbox-1" />
                                                    <input value="{{ $download_document->category_informasi_publik_id }}" hidden name="category_informasi_publik_id" type="text"
                                                        value="2" />
