        ...
        <div class="col-lg-12">
            <div class="card mb-4">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                    <h6 class="m-0 font-weight-bold text-primary">{{ __('Edit Pakta Integritas') }}</h6>
                ...
                <div class="table-responsive p-3">
                    <form action="{{ route('pakta-integritas-fba.update', $zona_integritas->id) }}" method="POST" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                                    ...
                                    <div class="d-flex flex-column align-items-center text-center p-3 py-5">
                                        ...
                                        <div class="col-sm">
                                            ...
                                            <div class="input-group my-3 text-center">
                                                <img id="output2" class="img-thumbnail" @isset($zona_integritas->image_content) src="{{ asset('images/pakta-integritas/'.$zona_integritas->image_content) }}" @endisset @empty($zona_integritas->image_content) src="{{ asset('images/default/upload-image.png') }}" @endempty>
                                            </div>
                                        </div>
                                        @error('image_content')
                                ...
                                <div class="col border-right">
                                    <div class="p-3 py-5">
                                        <div class="d-flex justify-content-between align-items-center mb-3">
                                            <h4 class="text-right">Pakta Integritas</h4>
                                        </div>
                                        <div class="row mt-2">
                                            <div class="col-md-12">
                                        ...
                                        <div class="row mt-3">
                                            <div class="col-md-12">
                                                ...
                                                <div class="form-check">
                                                    ...
                                                    <input value="{{ $zona_integritas->category_informasi_publik_id }}" hidden name="category_informasi_publik_id" type="text"
                                                        value="2" />
