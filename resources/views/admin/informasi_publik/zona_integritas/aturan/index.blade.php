...
@section('content')
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        ...
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">{{ __('Aturan Gratifikasi') }}</li>
        </ol>
    </div>
    <div class="row">
        <div class="col-lg-12">
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <form action="{{ route('aturan-gratifikasi-fba.header') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                    <table class="ml-2" style="width: 100%">
                        <tr>
                            ...
                            <td>: &nbsp; &nbsp;</td>
                            <td>
                                <input class="form-control @error('keyword') is-invalid @enderror" type="text"  name="keyword" id="keyword" @isset($zona_integritas->keyword) value="{{ $zona_integritas->keyword }}" @endisset>
                            </td>
                        </tr>
                        <tr>
                            <td>Image Header</td>
                            ...
                            <td class="pt-4">
                                <label for="file1">
                                    <img id="output1" style="width: 100px " class="img-thumbnail" @isset($zona_integritas->image_header) src="{{ asset('images/aturan-gratifikasi/'.$zona_integritas->image_header) }}" @endisset @empty($zona_integritas->image_header) src="{{ asset('images/default/upload-image.png') }}" @endempty>
                                </label> <br>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#dataTable').DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: "{{ route('aturan-gratifikasi-fba.index') }}",
                    type: 'GET',
                },
                "responsive": true,
                "language": {
        ...
        @include('admin.informasi_publik.zona_integritas.aturan.create')
    @include('admin.informasi_publik.zona_integritas.aturan.scriptdelete')
@endsection
