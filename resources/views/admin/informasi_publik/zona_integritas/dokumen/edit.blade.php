...
@section('content')
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        ...
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item">{{ __('Dokumen Zona Integritas') }}</li>
        ...
        <div class="col-lg-12">
            <div class="card mb-4">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                    <h6 class="m-0 font-weight-bold text-primary">{{ __('Edit Dokumen Zona Integritas') }}</h6>
                ...
                <div class="table-responsive p-3">
                    <form action="{{ route('dokumen-zona-integritas-fba.update', $zona_integritas->id) }}" method="POST" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                                        ...
                                        <div class="col border-right">
                                            <div class="p-3 py-5">
                                                <div class="d-flex justify-content-between align-items-center mb-3">
                                                    <h4 class="text-right">Dokumen Zona Integritas</h4>
                                                </div>
                                                <div class="row mt-2">
                                                    <div class="col-md-12">
                                                        <label class="labels">Judul</label>
                                                        <input type="text" name="title" value="{{ $zona_integritas->title }}" class="form-control" placeholder="ex : download dokumen zona integritas v1.pdf">
                                                        @error('title')
                                                ...
                                                <div class="row mt-3">
                                                    ...
                                                    <div class="col-md-12 mt-2">
                                                        ...
                                                        <input type="date" name="date"
                                                            ...
                                                            placeholder="" value="{{ $zona_integritas->date }}">
                                                        @error('date')
                                                            <small class="text-danger">{{ $message }}</small>
                                                        @enderror
                                                    </div>
