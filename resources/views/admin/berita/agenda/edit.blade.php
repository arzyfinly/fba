@extends('layout.app')
@section('title', 'Agenda FBA')
@section('agenda-fba-active', 'active')
...
@section('content')
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">{{ __('Agenda FBA') }}</h1>
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="./">{{ __('Home') }}</a></li>
            <li class="breadcrumb-item">{{ __('Berita') }}</li>
            <li class="breadcrumb-item">{{ __('Agenda FBA') }}</li>
        ...
        <div class="col-lg-12">
            <div class="card mb-4">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                    <h6 class="m-0 font-weight-bold text-primary">{{ __('Edit Agenda FBA') }}</h6>
                ...
                <div class="table-responsive p-3">
                    <form action="{{ route('agenda-fba.update', $agenda->id) }}" method="POST" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                                        ...
                                        <div class="row mt-2">
                                            <div class="col-md-12">
                                                ...
                                                <input type="text" name="title"
                                                    ...
                                                    placeholder="judul" value="{{ $agenda->title }}">
                                                @error('title')
                                            ...
                                            <div class="col-md-12 mt-2">
                                                ...
                                                <textarea class="form-control @error('content') is-invalid @enderror" name="content" id="exampleFormControlTextarea1"
                                                    rows="4" style="font-size: 10pt">{{ $agenda->content }}</textarea>
                                                @error('content')
                                                    <small class="text-danger">{{ $message }}</small>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="row mt-2">
                                            <div class="col-md-12">
                                                ...
                                                <input type="text" name="description"
                                                    ...
                                                    placeholder="Tempat" value="{{ $agenda->description }}">
                                                @error('description')
                                                    <small class="text-danger">{{ $message }}</small>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="row mt-3">
                                            <div class="col-md-6">
                                                ...
                                                <input type="time" name="start"
                                                    ...
                                                    placeholder="" value="{{ substr($agenda->image_content, 0, 5) }}">
                                                @error('start')
                                                    <small class="text-danger">{{ $message }}</small>
                                                @enderror
                                                ...
                                                <input type="time" name="end"
                                                    ...
                                                    placeholder="" value="{{ substr($agenda->image_content, 8, 12) }}">
                                                @error('end')
                                                    <small class="text-danger">{{ $message }}</small>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="row mt-3">
                                            <div class="col-md-12">
                                                ...
                                                <div class="form-check">
                                                    <input class="form-check-input" name="publish" @if ($agenda->publish == '1') checked @endif
