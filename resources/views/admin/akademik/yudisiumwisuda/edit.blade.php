@extends('layout.app')
@section('title', 'Yudisium & WIsuda FBA')
...
@section('content')
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">{{ __('Yudisium & WIsuda FBA') }}</h1>
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="./">{{ __('Home') }}</a></li>
            <li class="breadcrumb-item">{{ __('Akademik') }}</li>
            <li class="breadcrumb-item">{{ __('Yudisium & WIsuda FBA') }}</li>
        ...
        <div class="col-lg-12">
            <div class="card mb-4">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                    <h6 class="m-0 font-weight-bold text-primary">{{ __('Edit Yudisium & WIsuda FBA') }}</h6>
                ...
                <div class="table-responsive p-3">
                    <form action="{{ route('yudisium-wisuda-fba.update', $yudisiumwisuda->id) }}" method="POST" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
