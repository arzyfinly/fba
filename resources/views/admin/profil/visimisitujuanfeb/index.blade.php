...
@section('visi-misi-tujuan-fba-active', 'active')
...
@section('content')
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        ...
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">{{ __('Visi Misi & Tujuan FBA') }}</li>
        </ol>
    </div>
    <div class="row">
        <div class="col-lg-12">
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <form action="{{ route('visi-misi-tujuan-fba.header') }}" method="POST" enctype="multipart/form-data">
                        @csrf
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#dataTable').DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: "{{ route('visi-misi-tujuan-fba.index') }}",
                    type: 'GET',
                },
                "responsive": true,
                "language": {
    ...
    @include('admin.profil.visimisitujuanfeb.scriptdelete')
    @include('admin.profil.visimisitujuanfeb.create')
@endsection
