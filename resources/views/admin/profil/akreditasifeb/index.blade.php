...
@section('akreditasi-fba-active', 'active')
@section('profile-active', 'active')

@section('content')
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">{{ __('Akreditasi') }}</h1>
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="./">{{ __('Home') }}</a></li>
            <li class="breadcrumb-item">{{ __('Profil') }}</li>
            <li class="breadcrumb-item active" aria-current="page">{{ __('Akreditasi FBA') }}</li>
        </ol>
    </div>
    <div class="row">
        <div class="col-lg-12">
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <form action="{{ route('akreditasi-fba.header') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                    <table class="ml-2" style="width: 100%">
                        ...
                        <tr>
                            ...
                            <td class="pt-4">
                                <label for="file1">
                                    <img id="output1" style="width: 100px " class="img-thumbnail" @isset($profil->image_header) src="{{ asset('images/akreditasi-fakultas/'.$profil->image_header) }}" @endisset @empty($profil->image_header) src="{{ asset('images/default/upload-image.png') }}" @endempty>
                                </label> <br>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#dataTable').DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: "{{ route('akreditasi-fba.index') }}",
                    type: 'GET',
                },
                "responsive": true,
                "language": {
    ...
    @include('admin.profil.akreditasifeb.create')
    @include('admin.profil.akreditasifeb.scriptdelete')
@endsection
