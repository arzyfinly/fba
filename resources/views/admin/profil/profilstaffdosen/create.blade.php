                ...
                <div class="col-lg-12">
                    <div class="card mb-4">
                        <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                            <h6 class="m-0 font-weight-bold text-primary">{{ __('Create Dosen FBA') }}</h6>
                        ...
                        <div class="table-responsive p-3">
                            <form action="{{ route('staff-dosen-fba.store') }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                        ...
                                        <div class="col border-right">
                                            <div class="p-3 py-5">
                                                <div class="d-flex justify-content-between align-items-center mb-3">
                                                    <h4 class="text-right">Dosen FBA</h4>
                                                </div>
                                                <div class="row mt-2">
                                                    <div class="col-md-12">
                                                        ...
                                                        <select class="form-control" name="title" @error('title') is-invalid @enderror placeholder="judul">
                                                            ...
                                                            <option value="BAHASA DAN KEBUDAYAAN INGGRIS">Bahasa dan Kebudayaan Inggris</option>
                                                        </select>
                                                        @error('title')
                                                            <small class="text-danger">{{ $message }}</small>
                                                        @enderror
