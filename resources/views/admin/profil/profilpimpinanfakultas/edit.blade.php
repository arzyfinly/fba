...
@section('content')
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        ...
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item">{{ __('Pimpinan FBA') }}</li>
        ...
        <div class="col-lg-12">
            <div class="card mb-4">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                    <h6 class="m-0 font-weight-bold text-primary">{{ __('Edit Pimpinan FBA') }}</h6>
                ...
                <div class="table-responsive p-3">
                    <form action="{{ route('pimpinan-fba.update', $pimpinan->id) }}" method="POST" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                                    ...
                                    <div class="p-3 py-5">
                                        ...
                                        <div class="row mt-5">
                                            <div class="col-md-12 mt-5">
                                                <input class="form-check-input" @if ($pimpinan->publish == 1) checked @endif name="publish"
