...
class FasilitasController extends Controller
{
        ...
        if ($request->ajax()) {
            return DataTables::of($fasilitasAll)
                ...
                ->addColumn('image-content', function ($row) {
                    $content = '<img src="/images/fasilitas-fakultas/' . $row->image_content . '" alt="FBA" title="FBA" width="100px"/>';
                    return $content;
                })
                ...
                ->addColumn('action', function ($row) {
                    ...
                    $btn = '<a href="' . route('fasilitas-fba.edit', $row->id) . '" data-toggle="tooltip" data-original-title="Edit" class="edit btn btn-primary btn-sm"><span><i class="fas fa-pen-square"></i></span></a>';
                    $btn = $btn . '&nbsp;';
    ...
    public function header(Request $request)
    {
        ...
        return redirect('admin/profil/fasilitas-fba');
    }
    ...
    public function store(Request $request)
    {
        ...
        if($profil){
            if ($request['publish']) {
                ...
                return redirect()->route('fasilitas-fba.index');
        } else {
    ...
    {
        return redirect('/profil/fasilitas-fba');
    }
