...
class PengumumanController extends Controller
{
        ...
        if ($request->ajax()) {
            return DataTables::of($pengumumanAll)
                ...
                ->addColumn('image-content', function ($row) {
                    $content = '<img src="/images/berita-pengumuman/' . $row->image_content . '" alt="FBA" title="FBA" width="100px"/>';
                    return $content;
                })
                ...
                ->addColumn('action', function ($row) {
                    ...
                    $btn = '<a href="' . route('pengumuman-fba.edit', $row->id) . '" data-toggle="tooltip" data-original-title="Edit" class="edit btn btn-primary btn-sm"><span><i class="fas fa-pen-square"></i></span></a>';
                    $btn = $btn . '&nbsp;';
    ...
    public function header(Request $request)
    {
        ...
        return redirect('admin/berita/pengumuman-fba');
    }
    ...
    if($pengumuman){
        if ($request['publish'] != null) {
            ...
            return redirect()->route('pengumuman-fba.index');
    } else {
    ...
    {
        return redirect('/berita/pengumuman-fba');
    }
