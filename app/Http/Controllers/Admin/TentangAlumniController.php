...
class TentangAlumniController extends Controller
{
        ...
        if ($request->ajax()) {
            return DataTables::of($alumniAll)
                ...
                ->addColumn('image-content', function ($row) {
                    $content = '<img src="/images/tentang-alumni/' . $row->image_content . '" alt="FBA" title="FBA" width="100px"/>';
                    return $content;
                })
                ...
                ->addColumn('action', function ($row) {
                    ...
                    $btn = '<a href="' . route('tentang-alumni-fba.edit', $row->id) . '" data-toggle="tooltip" data-original-title="Edit" class="edit btn btn-primary btn-sm"><span><i class="fas fa-pen-square"></i></span></a>';
                    $btn = $btn . '&nbsp;';
    ...
    public function header(Request $request)
    {
        ...
        return redirect('admin/alumni/tentang-alumni-fba');
    }
    ...
    if($alumni){
        if ($request['publish'] != null) {
            ...
            return redirect()->route('tentang-alumni-fba.index');
    } else {
    ...
    {
        return redirect('/alumni/tentang-alumni-fba');
    }
